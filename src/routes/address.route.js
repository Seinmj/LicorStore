...
const { createAddress, deleteAddress, getAddress, getAddressById, getAddressIdLicorera, updateAddress, updateUserAddress, getAddressIdUser, createAddressUser } = require("../controllers/address.controllers");
...
router.put("/updateDireccionUsuario/:id", updateUserAddress);
